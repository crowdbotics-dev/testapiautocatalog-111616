...
## Project Structure
    ...
    ├── testapiautocatalog_111616  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111616`
...
2. Clone this repo and `cd testapiautocatalog_111616`
